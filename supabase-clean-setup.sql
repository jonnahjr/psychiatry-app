-- =========================================
-- TELE-PSYCHIATRY SYSTEM - CLEAN SUPABASE SETUP
-- Run this FIRST if you get "already exists" errors
-- =========================================

-- Drop existing objects (run this first if needed)
...
-- =========================================
-- NOW RUN THE MAIN SETUP SQL BELOW
-- =========================================
...
BEGIN
  ...
  RAISE NOTICE '✅ Test users and profiles created';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '1. Update backend/.env with Supabase credentials';
